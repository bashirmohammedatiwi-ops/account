...
function migrateReceipts(db) {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS receipts (
      ...
      cash_acc_seq TEXT DEFAULT '',
      commission_debit_acc_seq TEXT DEFAULT '',
      commission_credit_acc_seq TEXT DEFAULT '',
      discount_acc_seq TEXT DEFAULT '',
      edari_receipt_num TEXT DEFAULT '',
      edari_journal_num TEXT DEFAULT '',
    ...
    CREATE INDEX IF NOT EXISTS idx_receipts_customer ON receipts(customer_acc_seq);
