# Edari Emp — تطبيق موظفي تجهيز الطلبات (Flutter)

تطبيق هاتف لموظفي التجهيز يتصل بـ `/api/emp` على خادم delegate-portal.

## الميزات

- عرض طلبات الشراء وتصفيتها (قيد الانتظار / تم التجهيز / مرفوض)
- تفاصيل الطلب مع صور المنتجات
- **تعديل الكمية والهدايا** لكل بند
- **حذف منتج** من الطلب
- تغيير حالة الطلب
- **إشعارات** عند وصول طلب جديد (فحص دوري + FCM اختياري)
